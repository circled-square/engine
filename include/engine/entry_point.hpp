...
namespace engine {
    ...
    ENGINE_API void entry_point(std::optional<slogga::log_level> log_level_override, std::string project_file_path, glm::ivec2 wnd_res, const std::string& wnd_name, window::hints wnd_hints, std::function<rc<scene>()> get_start_scene);
}
