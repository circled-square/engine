//Custom imgui config to build it into a DLL
//-----------------------------------------------------------------------------
...
#    define IMCONFIG_API_EXPORT __declspec(dllexport)
#    define IMCONFIG_API_IMPORT __declspec(dllimport)
#else // GCC, or hopefully something GCC compatible
#    define IMCONFIG_API_EXPORT __attribute__((visibility("default")))
#    define IMCONFIG_API_IMPORT __attribute__((visibility("default")))
#endif

#if defined(ENGINE_BEING_COMPILED)
#    define IMGUI_API IMCONFIG_API_EXPORT
#else
#    define IMGUI_API IMCONFIG_API_IMPORT
#endif
